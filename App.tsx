      ...
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center animate-fade-in">
        <div className="w-full max-w-sm bg-white rounded-[2.5rem] p-10 premium-shadow border border-slate-100 space-y-8 relative overflow-hidden">
           ...
           <button 
             ...
             className={`w-full py-4 bg-white border border-slate-200 rounded-2xl flex items-center justify-center gap-3 text-sm font-black text-slate-700 hover:bg-slate-50 hover:border-indigo-200 active-scale transition-all shadow-sm ${isLoggingIn ? 'opacity-70 cursor-wait' : ''}`}
           >
             {isLoggingIn ? (
                <>
          ...
          <div className="flex items-center gap-2 sm:gap-4 overflow-hidden">
            ...
            <div className="flex flex-col min-w-0">
              <h1 className="text-lg sm:text-xl font-extrabold tracking-tight text-slate-900 flex items-center gap-1.5 truncate">
                れんと代購 <span className="text-indigo-600">Smart</span>
